...
const IconCart = () => (
  <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" aria-hidden="true">
    <path
      d="M3 4h2l2.4 12.3A2 2 0 0 0 9.4 18h7.9a2 2 0 0 0 2-1.6L21 8H6"
      stroke="currentColor"
      strokeWidth="1.6"
    />
...
const IconCog = () => (
  <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" aria-hidden="true">
    ...
    />
    <path
      d="M19 12a7 7 0 0 0-.1-1l2-1.5-2-3.5-2.3.7a7 7 0 0 0-1.7-1l-.4-2.4H11l-.4 2.4a7 7 0 0 0-1.7 1L6.6 6l-2 3.5L6.5 11a7 7 0 0 0 0 2l-2 1.5 2 3.5 2.3-.7a7 7 0 0 0 1.7 1l.4 2.4h3.2l.4-2.4a7 7 0 0 0 1.7-1l2.3.7 2-3.5-2-1.5c.1-.3.1-.7.1-1Z"
      stroke="currentColor"
      strokeWidth="1.2"
    />
  </svg>
...
const SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: "Unidades", href: "/admin/inventario/unidades" },
...
export default function AdminSidebar({
  ...
  const defaultOpen = useMemo(() => {
    ...
    for (const s of SECTIONS)
      open[s.id] = s.items.some((i) => pathname.startsWith(i.href));
    return open;
  }, [pathname]);
